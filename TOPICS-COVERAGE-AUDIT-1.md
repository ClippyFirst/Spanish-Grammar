...
3. Кожна тема: логіка → утворення → вживання → приклади → помилки UA → related.
...
| 4–7 Pronombre/Det. | §7 |
| 8 Adverbio | §6 |
| 9 Verbo | §10–13 (AUDIT-2) |
| 14–15 Coordinación/Sub. | §9 |
| Ortografía | §2 |
...
- [x] ✅ Поняття: слово, морфема, основа, закінчення; частини мови → `fundamentals/grammar-basics`
...
- [x] ✅ Дата, час, години → `fundamentals/date-time-numbers`
- [x] ✅ Кількісні числівники → `fundamentals/date-time-numbers`
- [x] ✅ Порядкові числівники → `fundamentals/ordinal-numbers`
...
- [x] ✅ Злічувані / незлічувані → `nouns/noun-special-cases`
- [x] ✅ Колективні (gente, equipo…) → `nouns/noun-special-cases`
...
- [x] ✅ Означений → `articles/definite-indefinite`
- [x] ✅ Неозначений → `articles/definite-indefinite`
- [x] ✅ Означений vs неозначений ⭐ → `articles/definite-vs-indefinite`
- [x] ✅ Нульовий артикль; nombres escuetos ⭐ → `articles/zero-article`
...
- [x] ✅ Утворення (-mente) → `adverbs/formation-and-position`
- [x] ✅ Позиція → `adverbs/formation-and-position`
...
- [x] ✅ también / tampoco → `adverbs/focus-and-stance`
- [x] ✅ nunca, jamás, casi, apenas, incluso, hasta, solo → `adverbs/focus-and-stance`
...
- [x] ✅ Dativo posesivo ⭐ → `pronouns/body-parts-possession`
- [x] ✅ Неозначені → `pronouns/indefinite-pronouns`
- [x] ✅ Mismo → `pronouns/mismo-uno-generic`
- [x] ✅ Cualquiera / quienquiera / dondequiera → `pronouns/mismo-uno-generic`
- [x] ✅ Uno безособове; generic tú → `pronouns/mismo-uno-generic`
- [x] ✅ Питальні → `pronouns/interrogative-pronouns`
- [x] ✅ Exclamativos → `pronouns/exclamatives`
- [x] ✅ Відносні ⭐ → `pronouns/relative-pronouns`
- [x] ✅ Відносні без антецедента → `pronouns/relative-pronouns`
- [x] ✅ Обмежувальні vs пояснювальні → `pronouns/relative-pronouns`
...
- [x] ✅ Дискурсивні конектори ⭐ → `conjunctions/discourse-connectors`
- [x] ✅ Розмовні маркери → `conjunctions/discourse-fillers`
