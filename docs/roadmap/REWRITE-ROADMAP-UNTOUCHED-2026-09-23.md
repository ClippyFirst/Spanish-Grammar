...
**Станом на 23.09.2026:** 196 MDX-сторінок загалом; 80 уже змінені в попередніх rewrite passes; **98 залишаються** в untouched/review backlog. Нижче — саме ці 117 сторінок.
